...
import com.sujanix.cruxmdm.presentation.adapter.SliderAdapter
import com.sujanix.cruxmdm.data.model.SliderData
...
import com.sujanix.cruxmdm.util.SystemUtils
import com.sujanix.cruxmdm.util.isDeviceOwner
...
class EnrollActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(!SystemUtils.isDeviceAdminActive(applicationContext)) {
            ...
            com.sujanix.cruxmdm.util.showDialog(
                activity = this,
